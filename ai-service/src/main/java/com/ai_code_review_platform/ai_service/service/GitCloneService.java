...
public class GitCloneService {
    ...
    public void cloneRepository(String repoUrl, String branchName) {
        try {
            String localPath = "repositories/" + branchName;

            Git.cloneRepository().setURI(repoUrl).setDirectory(new File(localPath)).setBranch(branchName).call();
            log.info(
